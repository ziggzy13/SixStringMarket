...
/**
 * Modern registration screen with animated validation, tooltips, and enhanced
 * user experience
 */
public class RegistrationFrame extends JFrame {
	...
	private void initComponents() {
		...
		JPanel backgroundPanel = new JPanel() {
			...
			protected void paintComponent(Graphics g) {
				...
				GradientPaint gradient = new GradientPaint(0, 0, ColorScheme.PRIMARY, 0, getHeight(),
	...
	private JPanel createFormPanel() {
		...
		addressArea.setBorder(BorderFactory.createCompoundBorder(
				BorderFactory.createLineBorder(ColorScheme.FIELD_BORDER), BorderFactory.createEmptyBorder(8, 8, 8, 8)));
	...
	private JPanel createWelcomePanel() {
		JPanel panel = new JPanel() {
			...
			protected void paintComponent(Graphics g) {
				...
				GradientPaint gradient = new GradientPaint(0, 0, ColorScheme.SECONDARY, 0, getHeight(),
						ColorScheme.darken(ColorScheme.SECONDARY, 0.3f));
				g2d.setPaint(gradient);
				g2d.fillRect(0, 0, getWidth(), getHeight());
		...
		// Improved V-shaped guitar - more symmetrical and cleaner design
		JLabel logoLabel = new JLabel() {
		    ...
		    protected void paintComponent(Graphics g) {
		        ...
		        // Apply rotation for diagonal look
		        g2d.translate(getWidth()/2, getHeight()/2);
		        g2d.rotate(Math.toRadians(45));
		        g2d.scale(0.7, 0.7); // Scaling down
		        g2d.translate(-45, -60);
		        
		        // Main color
		        g2d.setColor(Color.WHITE);
		        
		        // Improved symmetrical V-shaped body
		        int[] bodyXPoints = {45, 75, 60, 45, 30, 15};
		        int[] bodyYPoints = {60, 130, 150, 110, 150, 130};
		        g2d.fillPolygon(bodyXPoints, bodyYPoints, bodyXPoints.length);
		        
		        // Neck - slightly wider and more centered
		        g2d.fillRect(42, 0, 6, 60);
		        
		        // Better symmetrical headstock
		        int[] headXPoints = {36, 54, 54, 45, 36};
		        int[] headYPoints = {0, 0, -8, -18, -8};
		        g2d.fillPolygon(headXPoints, headYPoints, headXPoints.length);
		        
		        // Pickups - better positioned
		        g2d.setColor(Color.DARK_GRAY);
		        g2d.fillRect(35, 75, 20, 8);
		        g2d.fillRect(35, 90, 20, 8);
		        
		        // Bridge - more centered
		        g2d.fillRect(38, 115, 15, 5);
		        
		        // Tuning pegs - more evenly spaced
		        g2d.setColor(Color.LIGHT_GRAY);
		        for (int i = 0; i < 3; i++) {
		            g2d.fillOval(34, -13 + i*5, 3, 3);
		            g2d.fillOval(53, -13 + i*5, 3, 3);
		        }
		        
		        // Fretboard - slightly wider
		        g2d.setColor(new Color(40, 40, 40));
		        g2d.fillRect(41, 0, 8, 60);
		        
		        // Frets - more evenly spaced
		        g2d.setColor(Color.LIGHT_GRAY);
		        for (int i = 0; i < 8; i++) {
		            int y = 7 + i * 7;
		            g2d.drawLine(41, y, 49, y);
		        }
		        
		        // Strings - more evenly spaced
		        g2d.setColor(new Color(220, 220, 220));
		        g2d.setStroke(new BasicStroke(0.7f));
		        for (int i = 0; i < 6; i++) {
		            float offset = 42f + i * 1.2f;
		            g2d.drawLine(Math.round(offset), -15, Math.round(offset), 120);
		        }
		        
		        // Volume/tone knobs - better positioned
		        g2d.setColor(Color.LIGHT_GRAY);
		        g2d.fillOval(57, 100, 5, 5);
		        g2d.fillOval(63, 95, 5, 5);
		...
		String[] benefits = { "Buy and sell guitars easily", "Connect with other musicians",
				"Find rare & vintage instruments", "Safe and secure transactions", "Join our growing community" };
	...
	private JTextField createStyledTextField() {
		...
		field.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createLineBorder(ColorScheme.FIELD_BORDER),
		...
		field.addFocusListener(new FocusAdapter() {
			...
			public void focusGained(FocusEvent e) {
				field.setBorder(
						BorderFactory.createCompoundBorder(BorderFactory.createLineBorder(ColorScheme.SECONDARY),
								BorderFactory.createEmptyBorder(8, 8, 8, 8)));
			}
			...
			public void focusLost(FocusEvent e) {
				field.setBorder(
						BorderFactory.createCompoundBorder(BorderFactory.createLineBorder(ColorScheme.FIELD_BORDER),
								BorderFactory.createEmptyBorder(8, 8, 8, 8)));
			}
		});
	...
	private void register() {
		...
		// CHANGE 3: For phone, if it's empty set to null, otherwise use as is (skip
		// validation)
		String phoneToUse = phone.isEmpty() ? null : phone;
		...
		SwingWorker<Boolean, Void> worker = new SwingWorker<Boolean, Void>() {
			...
			protected Boolean doInBackground() throws Exception {
				...
				Thread.sleep(800);
				try {
					return userService.registerUser(username, password, email, phoneToUse, address);
